...
class UnetActorDiscrete(nn.Module):
    ...
    def forward_actor(self, x, t, gt_action):
        ...
        log_prob_all_action1 = F.log_softmax(logits, dim=-1)

        gt_action = gt_action.unsqueeze(-1)
        log_prob_output = log_prob_all_action1.gather(dim=2, index=gt_action)
